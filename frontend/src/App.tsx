...
import { AppLayout, TextContent, TopNavigation, Spinner, Alert } from '@cloudscape-design/components';
            ...
            >
              <TextContent>
                <ul>
                  ...
                  <li>Select Accept/Pay Fees and complete the payment process.</li>
                </ul>
                <h5>Note: If you do not complete these two steps, you will be dropped from your classes.</h5>
              </TextContent>
